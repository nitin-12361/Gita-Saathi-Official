...
fun VoiceSettingsDialog(
    ...
    currentAudioMode: AudioMode = AudioMode.SANSKRIT_SHLOKA,
    ...
    var selectedAudioMode by remember { mutableStateOf(currentAudioMode) }
            ...
            Column(
                ...
                Row(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Column {
                            Text(
                                text = if (appLanguage == AppLanguage.HINDI) "श्लोक गायन सेटिंग्स" else "Sanskrit Recitation Settings",
                                fontSize = 18.sp,
                            ...
                            Text(
                                text = if (appLanguage == AppLanguage.HINDI) "प्रामाणिक संस्कृत श्लोक वाचन एवं गति" else "Authentic Sanskrit chanting & speed",
                                fontSize = 12.sp,
                ...
                // Section 1: Chanting Speed / Pace
                Text(
                    text = if (appLanguage == AppLanguage.HINDI) "1. श्लोक वाचन गति" else "1. Chanting Speed",
                    fontSize = 14.sp,
                    fontWeight = FontWeight.Bold,
                ...
                val speedOptions = listOf(
                    ...
                    1.0f to if (appLanguage == AppLanguage.HINDI) "1.0x (मानक)" else "1.0x (Default)",
                    1.25f to if (appLanguage == AppLanguage.HINDI) "1.25x (तेज)" else "1.25x (Fast)"
                )
                ...
                // Section 2: Voice Style Options
                Text(
                    text = if (appLanguage == AppLanguage.HINDI) "2. भक्तिमय वाचन शैली" else "2. Chanting Resonance",
                    fontSize = 14.sp,
                    fontWeight = FontWeight.Bold,
                    color = MaterialTheme.colorScheme.primary
                )
